package com.es.easysupervise.widget;
...
//    private static final String TAG = "XListView";
    ...
    // when pull up >= 240px
    private final static int PULL_LOAD_MORE_DELTA = 240;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
            if (mEnableAutoLoad && getLastVisiblePosition() == getCount() - 1 && mFooterView.mState == XFooterView.STATE_READY) {
                startLoadMore();
            }
        }
    }
